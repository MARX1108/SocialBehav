...
```{r}
cm_tb<-bootstrap_glm(df, T=GlobalT, filesname = './final/Prosocial-Attributes-EPF.csv')
write.csv(cm_tb,"./final/Prosocial-Results-EPF.csv", row.names = FALSE)
```
...
```{r}
cm_tb<-bootstrap_glm(df, T=GlobalT, filesname = './final/Prosocial-Attributes-brain.csv')
write.csv(cm_tb,"./final/Prosocial-Results-brain.csv", row.names = FALSE)
```
...
```{r}
cm_tb<-bootstrap_glm(df, T=GlobalT, filesname = './final/Prosocial-Attributes-brain+EPF.csv')
write.csv(cm_tb,"./final/Prosocial-Results-brain+EPF.csv", row.names = FALSE)
```
