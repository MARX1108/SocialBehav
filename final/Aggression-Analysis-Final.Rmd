...
bootstrap_glm <- function(df, T, plot=TRUE, n)
{
...
```{r}
cm_tb<-bootstrap_glm(df, T=5000, n=4000)
write.csv(cm_tb,"./final/aggression-EPF-glm.csv", row.names = FALSE)
```
